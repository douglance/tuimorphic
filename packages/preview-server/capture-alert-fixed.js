...
(async () => {
  ...
  await page.screenshot({
    path: '/Users/douglance/Developer/lv/tuimorphic/packages/preview-server/screenshots/alert-fixed.png',
    fullPage: false
  });

  console.log('Screenshot saved to screenshots/alert-fixed.png');
