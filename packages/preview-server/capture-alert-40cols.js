...
(async () => {
  ...
  console.log('Clicked Alert button, waiting 3 seconds...');
  ...
  await page.screenshot({
    path: '/Users/douglance/Developer/lv/tuimorphic/packages/preview-server/screenshots/alert-40cols.png',
    fullPage: false
  });

  console.log('Screenshot saved to screenshots/alert-40cols.png');
