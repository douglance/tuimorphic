...
async function captureAlertFinal() {
  ...
  // Take screenshot
  const screenshotPath = '/Users/douglance/Developer/lv/tuimorphic/packages/preview-server/screenshots/alert-final.png';
...
captureAlertFinal().catch(console.error);
