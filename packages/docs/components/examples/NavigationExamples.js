...
export function NavigationBasic() {
    return (<Navigation logo={<span style={{ fontWeight: 'bold' }}>ACME</span>} items={[
...
export function NavigationWithActions() {
    return (<Navigation logo={<span style={{ fontWeight: 'bold' }}>APP</span>} items={[
...
export function NavigationNoBorder() {
    return (<Navigation logo={<span style={{ fontWeight: 'bold' }}>MINIMAL</span>} items={[
            { label: 'Features', href: '#' },
            { label: 'Pricing', href: '#' },
...
export function NavigationClickHandlers() {
    return (<Navigation logo={<span style={{ fontWeight: 'bold' }}>SPA</span>} items={[
...
export function MenuBasic() {
    return (<Menu trigger={<Button variant="secondary">Open Menu</Button>}>
...
export function MenuWithActions() {
    return (<Menu trigger={<Button variant="secondary">Actions</Button>}>
...
export function MenuUserActions() {
    return (<Menu trigger={<Button variant="secondary">[USER] Account</Button>}>
