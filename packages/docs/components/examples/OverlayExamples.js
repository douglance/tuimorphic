...
export function DialogBasic() {
    return (<Dialog trigger={<Button>Open Dialog</Button>} title="DIALOG TITLE">
      <p>This is the dialog content. Click [X] or outside to close.</p>
    </Dialog>);
}
export function DialogWithContent() {
    return (<Dialog trigger={<Button>Open Form Dialog</Button>} title="CONTACT FORM">
      <form className="space-y-4">
        <div>
          <label className="block mb-1">Name:</label>
          <input type="text" className="w-full px-2 py-1 border border-current bg-transparent" placeholder="Enter your name"/>
        </div>
        <div>
          <label className="block mb-1">Email:</label>
          <input type="email" className="w-full px-2 py-1 border border-current bg-transparent" placeholder="Enter your email"/>
        </div>
        <div>
          <label className="block mb-1">Message:</label>
          <textarea className="w-full px-2 py-1 border border-current bg-transparent" rows={3} placeholder="Enter your message"/>
        </div>
...
export function DrawerBasic() {
    return (<Drawer trigger={<Button>Open Left Drawer</Button>} title="NAVIGATION" side="left">
      <p>This drawer slides in from the left side of the screen.</p>
    </Drawer>);
}
export function DrawerRight() {
    return (<Drawer trigger={<Button>Open Right Drawer</Button>} title="SETTINGS" description="Configure your preferences" side="right">
...
export function DrawerBottom() {
    return (<Drawer trigger={<Button>Open Bottom Drawer</Button>} title="DETAILS" side="bottom">
...
export function DrawerWithContent() {
    return (<Drawer trigger={<Button>Open Menu</Button>} title="MAIN MENU" side="left">
...
export function PopoverBasic() {
    return (<Popover trigger={<Button>Show Info</Button>}>
      <div className="p-2">
...
export function PopoverPositions() {
    return (<div className="flex gap-4 flex-wrap items-center justify-center py-8">
...
export function PopoverWithForm() {
    ...
    return (<Popover trigger={<Button>Subscribe</Button>} side="bottom" align="start">
      <div className="p-3 w-64">
        <p className="font-bold mb-2">NEWSLETTER</p>
        <p className="text-sm mb-3">Subscribe to our updates:</p>
        <input type="email" value={email} onChange={(e) => setEmail(e.target.value)} className="w-full px-2 py-1 border border-current bg-transparent mb-2" placeholder="your@email.com"/>
