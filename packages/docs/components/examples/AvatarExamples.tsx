...
export function AvatarBasic() {
  return (
    <Avatar
      src="https://api.dicebear.com/7.x/identicon/svg?seed=tuimorphic"
      alt="User avatar"
    />
  );
}
...
export function AvatarWithImage() {
  return (
    <div className="flex gap-4 items-center">
      ...
      />
      <Avatar
        src="https://api.dicebear.com/7.x/identicon/svg?seed=user2"
        alt="User 2"
        size="medium"
      />
      <Avatar
        src="https://api.dicebear.com/7.x/identicon/svg?seed=user3"
        alt="User 3"
        size="large"
      />
    </div>
...
export function AvatarAsLink() {
  return (
    <div className="flex gap-4 items-center">
      <Avatar
        src="https://api.dicebear.com/7.x/identicon/svg?seed=github"
        alt="GitHub Profile"
