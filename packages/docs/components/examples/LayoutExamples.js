...
import { Tabs, TabsList, TabsTrigger, TabsContent, Accordion, AccordionItem, AccordionTrigger, AccordionContent, Card, CardDouble, CardDoubleInner, Divider, Table, TableHeader, TableBody, TableRow, TableHead, TableCell, TableCaption, SidebarLayout, } from 'tuimorphic';
// ============================================================================
// Tabs Examples
// ============================================================================
...
export function AccordionDefaultOpen() {
    return (<Accordion defaultValue={['faq-1']}>
...
export function AccordionSingleMode() {
    return (<Accordion type="single" defaultValue={['section-1']}>
...
export function CardWithTitle() {
    return (<Card title="SYSTEM STATUS">
...
export function DividerVertical() {
    return (<div className="flex items-center gap-4 h-16">
...
export function TableStriped() {
    return (<Table striped size="compact">
      <TableHeader>
        <TableRow>
...
export function TableWithSelection() {
    ...
    return (<Table bordered>
      ...
      <TableBody>
        {data.map((row) => (<TableRow key={row.id} selected={selectedRow === row.id} onClick={() => setSelectedRow(row.id)} style={{ cursor: 'pointer' }}>
...
export function CardDoubleBasic() {
    return (<CardDouble title="SYSTEM INFO">
      <p>System status: OK</p>
      <p>Last checked: 2024-01-15 14:32:00 UTC</p>
    </CardDouble>);
}
export function CardDoubleWithCorners() {
    return (<CardDouble title="MAIN WINDOW" leftCorner="[1]" rightCorner="[X]">
...
export function CardDoubleNested() {
    return (<CardDouble title="APPLICATION">
...
export function SidebarLayoutBasic() {
    return (<SidebarLayout sidebar={<nav className="p-2">
        ...
        </nav>} style={{ height: '200px', border: '1px solid var(--theme-border)' }}>
      <div className="p-4">
        <h3>Main Content</h3>
...
export function SidebarLayoutResizable() {
    return (<SidebarLayout sidebar={<nav className="p-2">
        ...
        </nav>} defaultSidebarWidth={180} minSidebarWidth={120} maxSidebarWidth={300} showHandle style={{ height: '200px', border: '1px solid var(--theme-border)' }}>
      <div className="p-4">
...
export function SidebarLayoutCollapsible() {
    return (<SidebarLayout sidebar={<nav className="p-2">
        ...
        </nav>} collapsible style={{ height: '200px', border: '1px solid var(--theme-border)' }}>
      <div className="p-4">
...
export function SidebarLayoutRight() {
    return (<SidebarLayout sidebar={<aside className="p-2">
          <p className="mb-2"><strong>Details</strong></p>
          <p>File: document.txt</p>
          <p>Size: 12KB</p>
          <p>Modified: Jan 15</p>
        </aside>} side="right" collapsible defaultSidebarWidth={150} style={{ height: '200px', border: '1px solid var(--theme-border)' }}>
      <div className="p-4">
        <h3>Right Sidebar</h3>
...
export function SidebarLayoutFull() {
    return (<SidebarLayout sidebar={<nav className="p-2">
        ...
        </nav>} defaultSidebarWidth={160} minSidebarWidth={120} maxSidebarWidth={250} showHandle collapsible style={{ height: '240px', border: '1px solid var(--theme-border)' }}>
      <div className="p-4">
